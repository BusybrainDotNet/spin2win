<section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="<?= baseURL('ad-index/'); ?><?= $adminInfo['uniqueid']; ?>/" class="logo"><img src="/Images/favicon.png" alt="Logo" class="img-circle" style="max-width: 80px; max-height: 50px; padding: 5px;"></a>
      <!--logo end-->
      <div class="top-menu">
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              ...
              <span class="badge bg-info"><?= $countMsg; ?></span>
              </a>
          ...
          <!-- notification dropdown start-->
           <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <a href="<?= baseURL('tickets/'); ?><?= $adminInfo['uniqueid']; ?>/?c=Unread">See all notifications</a>
              </li>
            </ul>
          </li> 
        ...
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="<?= baseURL('logout/'); ?><?= $adminInfo['uniqueid']; ?>/">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->