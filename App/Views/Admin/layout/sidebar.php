    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered"><?= $adminInfo['profile']; ?> <?= $adminInfo['username']; ?></h5>
          <li class="mt">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="<?= baseURL('all-users/'); ?><?= $adminInfo['uniqueid']; ?>/?c=All"> Users</a></li>
              <li><a href="<?= baseURL('all-newsletter/'); ?><?= $adminInfo['uniqueid']; ?>/?c=All"> Subscribers</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="<?= baseURL('projects/'); ?><?= $adminInfo['uniqueid']; ?>/?c=All">Sales</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="<?= baseURL('set-priviledges/'); ?><?= $adminInfo['uniqueid']; ?>/">Priviledges</a></li>
            </ul>
          </li>
          
          <li>
            <a href="<?= baseURL('logout/'); ?><?= $adminInfo['uniqueid']; ?>/">
