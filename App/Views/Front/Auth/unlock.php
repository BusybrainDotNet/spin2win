...
<title>Member Area | Unlock Account | <?= getenv('APP_NAME'); ?></title>
    ...
    <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
      <div class="container">
        ...
        <ul class="breadcrumbs-custom-path mt-2">
          ...
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> Unlock Account </li>
        </ul>
      </div>
    </div>
  </section>
   ...
   <section class="w3l-contact-11 py-5">
    <div class="contacts-main py-lg-5 py-md-4">
      <div class="title-content text-center">
        <h6 class="sub-titlehny">Enter The Unlock Code To Gain </h6>
        <h3 class="hny-title"> Unlock Account</h3>
    </div>
        ...
        <div class="container">
          ...
          <div class="d-grid align-form-map">
            <div class="form-inner-cont">
              ...
              <form action="<?= baseURL('unlock/'); ?>" method="POST" class="signin-form">
                
                <input type="hidden" name="ip" value="<?php echo $ip?>">
                <input type="hidden" name="ua" value="<?php echo $user_agent?>">
                <input type="hidden" name="u" value="<?php echo $id?>">
                <input type="hidden" name="e" value="<?php echo $user?>">

                <div class="form-input">
                  <label for="w3lName">Key | Code (Required)*</label>
                  <input type="text" name="c" id="w3lName" placeholder="Key | Code" required/>
                </div>

                <div class="form-submit text-left mt-3 mb-5">
                    <button type="submit" class="btn btn-style btn-primary" name="unlock">Continue</button>
                </div>

              </form>

              <p class="text-3 text-left text-muted">Not <?php echo $user?>? <a class="btn-link" href="<?= baseURL('login/'); ?>">Login</a></p>
