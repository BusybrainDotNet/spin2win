...
<title>Member Area | Login | <?= getenv('APP_NAME'); ?></title>
   ...
   <section class="w3l-contact-11 py-5">
    <div class="contacts-main py-lg-5 py-md-4">
      <div class="title-content text-center">
        <h6 class="sub-titlehny">Fill The Form Fields Below To Login</h6>
        ...
        <div class="container">
          ...
          <div class="d-grid align-form-map">
            <div class="form-inner-cont">
              ...
              <form action="<?= baseURL('member-area/'); ?>" method="POST" class="signin-form">
                ...
                <div class="form-input">
                 ...
                 <p class="text-1 text-muted">Forgot Password? <a class="btn-link" href="<?= baseURL('forgot-password/'); ?>">Reset</a></p>

                <div class="form-submit text-left mt-3 mb-5">
                    <button type="submit" class="btn btn-style btn-primary" name="signin">Continue</button>
                </div>
