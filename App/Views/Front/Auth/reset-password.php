...
<title>Member Area | Reset Password | <?= getenv('APP_NAME'); ?></title>
   ...
   <section class="w3l-contact-11 py-5">
    <div class="contacts-main py-lg-5 py-md-4">
      <div class="title-content text-center">
        <h6 class="sub-titlehny">Enter The Reset Code In Your Email To Reset Your Password </h6>
        <h3 class="hny-title">Create New Password</h3>
    </div>
          ...
          <div class="d-grid align-form-map">
            <div class="form-inner-cont">
              ...
              <form action="<?= baseURL('forgot-password/'); ?>" method="POST" class="signin-form">
                ...
                <div class="form-input">
                  <label for="w3lName">New Password (Required)*</label>
                  <input type="password" name="p" id="w3lName" placeholder="************" required/>
                </div>

                <div class="form-submit text-left mt-3 mb-5">
                    <button type="submit" class="btn btn-style btn-primary" name="reset">Continue</button>
                </div>

              </form>

              <p class="text-3 text-left text-muted">Not <?php echo $name?>? <a class="btn-link" href="<?= baseURL('login/'); ?>">Login</a></p>
